...
/***/ (function(module, exports, __webpack_require__) {
	...
	AFRAME.registerComponent('keyboard', {
	  ...
	  init: function init() {
	    ...
	    var numericalUI = Draw.numericalUI(this.el.components.position.data),
	        mainUI = Draw.mainUI(this.el.components.position.data),
	        actionsUI = Draw.actionsUI(this.el.components.position.data);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Draw.numericalUI = function (position) {
	  var wrapper = document.createElement('a-entity');
	  //wrapper.setAttribute('position', '0.025 0 0.12');
	  //wrapper.setAttribute('position', '0.025 0.75 0.12');
	  var endPos = new THREE.Vector3(0.025, 0, 0.12);
	  endPos.add(position);
	  wrapper.setAttribute('position', endPos);
	...
	Draw.mainUI = function (position) {
	  var wrapper = document.createElement('a-entity');
	  //wrapper.setAttribute('position', '0.312 0 0');
	  var endPos = new THREE.Vector3(0.312, 0, 0);
	  endPos.add(position);
	  wrapper.setAttribute('position', endPos);
	  wrapper.setAttribute('data-ui', true);
	...
	Draw.actionsUI = function (position) {
	  var wrapper = document.createElement('a-entity');
	  //wrapper.setAttribute('position', '1.180 0 0.01');
	  var endPos = new THREE.Vector3(1.180, 0, 0.01);
	  endPos.add(position);
	  wrapper.setAttribute('position', endPos);
	  wrapper.setAttribute('rotation', '0 -25 0');
	  wrapper.setAttribute('data-ui', true);
